...
const char * const BITCOIN_CONF_FILENAME = "tealcoin.conf";
const char * const BITCOIN_PID_FILENAME = "tealcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tealcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Tealcoin";
#else
    // Unix
    return pathRet / ".tealcoin";
#endif
#endif
}
