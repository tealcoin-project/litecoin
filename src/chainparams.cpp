...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00"); // (block 170) update nMinimumChainWork with information from the getblockchaininfo rpc call or getblock rpc call

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); // (block 170) update defaultAssumeValid  with information from the getblockhash rpc call
        ...
        chainTxData = ChainTxData{
            0, // * UNIX timestamp of last known number of transactions (block 140)
