...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1, 5 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.tealcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("tealcointools.com", "dnsseed.tealcointools.com"));
        vSeeds.push_back(CDNSSeedData("tealcoinpool.org", "dnsseed.tealcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 293345, 0x1e0ffff0, 1, 5 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.push_back(CDNSSeedData("tealcointools.com", "testnet-seed.tealcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.tealcoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 0, 0x207fffff, 1, 5 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
