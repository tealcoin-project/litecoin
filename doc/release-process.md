...
space *do not upload these to the tealcoin.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the tealcoin.org server.

```

- Update tealcoin.org version

- Announce the release:

  - tealcoin-dev and tealcoin-dev mailing list

  - blog.tealcoin.org blog post
